            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#content"
                        aria-expanded="{{ ($segment2 == 'banner' || $segment2 == 'add_edit_banner' || $segment2 == 'homeContent' || $segment2 == 'aboutContent' || $segment2 == 'cms' || $segment2 == 'add_edit_cms')?'true':'false' }}" aria-controls="content">
                        <span class="nav-icon">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <!-- Product box -->
                    ...
                    <div id="content" class="collapse submenu content {{ ($segment2 == 'banner' || $segment2 == 'add_edit_banner' || $segment2 == 'homeContent' || $segment2 == 'story-content' || $segment2 == 'cms' || $segment2 == 'add_edit_cms')?'show':'' }}" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link {{ ($segment2 == 'story-content')?'active':'' }}" href="{{ url('admin/story-content') }}">The Story Content</a>
                            </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1 {{ ($segment2 == 'product_category' || $segment2 == 'products' || $segment2 == 'add_edit_product' || $segment2 == 'cocktails' || $segment2 == 'add_edit_cocktail')?'show':'' }}" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link {{ ($segment2 == 'cocktails' || $segment2 == 'add_edit_cocktail')?'active':'' }}" href="{{ url('admin/cocktails') }}">Cocktails</a>
                            </li>
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ ($segment2 == 'cocktail-club')?'active':'' }}"
                        href="{{ url('admin/cocktail-club') }}">
                        <span class="nav-icon">
                            <svg width="24" height="24" viewBox="0 0 128 128" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            <!-- Glass -->
                            <path d="M24 20H104L72 64V104H56V64L24 20Z"
                                    fill="#1E1E1E" stroke="#000" stroke-width="3"/>

                            <!-- Stem -->
                            <rect x="60" y="104" width="8" height="14" fill="#1E1E1E"/>

                            <!-- Base -->
                            <rect x="44" y="118" width="40" height="6" rx="3" fill="#1E1E1E"/>

                            <!-- Liquid -->
                            <path d="M36 28H92L70 56H58L36 28Z"
                                    fill="#FF4D6D"/>

                            <!-- Garnish (Olive / Cherry) -->
                            <circle cx="84" cy="30" r="6" fill="#2ECC71"/>
                            <line x1="84" y1="30" x2="92" y2="18"
                                    stroke="#2ECC71" stroke-width="2"/>
                            </svg>

                        </span>
                        <span class="nav-link-text">Cocktail Club</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
