...
<div class="app-content pt-3 p-md-3 p-lg-4">
	<div class="container-xl">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
										...
										<textarea class="form-control" id="opening_hours" name="opening_hours">{{ old('opening_hours', $settings->opening_hours ?? '') }}</textarea>
									</div>
								</div>
		...
		<div class="row g-4 settings-section">
			<div class="col-12 col-md-4">
				<h3 class="section-title">Map Address</h3>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
										...
										<textarea class="form-control" id="map_address" name="map_address" style="height: 120px;">{{ old('map_address', $settings->map_address ?? '') }}</textarea>
									</div>
								</div>
								<?php /* <div class="col-md-12">
									<div class="mb-3">
										<label for="map_direction" class="form-label">Map Direction</label>
										<input type="text" class="form-control" id="map_direction" name="map_direction"
											value="{{ old('map_direction', $settings->map_direction ?? '') }}">
									</div>
								</div>
								<div class="col-md-12">
									<div class="mb-3">
