                    ...
                    <div class="bg-white p-4">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Who's behind this creation?">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="Give your drink a bold, unforgettable title.">
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Short Description <span
                                        class="optional-text">(optional)</span></label>
                                <input type="text" class="form-control"
                                    placeholder="A fiery one-liner that captures the soul of your cocktail.">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="rich-editor-box">
                                    <textarea class="editor-textarea"
                                        placeholder="Break down your ritual, step by step, so others can recreate your magic."></textarea>
                                </div>
                            </div>
