    ...
    public function edit_profile(Request $request){
        ...
        if ($request->isMethod('POST')){
            ...
            if(!empty($post)){
                ...
                $updated = AdminModel::where('user_id', session('user_id'))->update($post);
                if($updated){
                    $user_info =  AdminModel::where(['user_id'=>session('user_id')])->first();
        ...
        $data['profile'] = AdminModel::where(['user_id'=>session('user_id')])->first();
